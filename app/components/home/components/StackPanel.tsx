...
import { stackCore, stackExpertise, stackSupport } from '@/app/components/home/model/site-content';
    ...
    <Panel>
      <div className="p-5 sm:p-7">
        <div className="mb-5 flex items-center gap-3">
          <Cpu
            className={cn('h-6 w-6', isThemeAlt ? 'text-sky-300' : 'text-[var(--hero-secondary)]')}
          />
          <h2 className="md:text-xl font-bold uppercase tracking-widest">{content.stackTitle}</h2>
        </div>
        <div
          className={cn(
